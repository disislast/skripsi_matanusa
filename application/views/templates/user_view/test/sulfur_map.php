...
<body id="page-top">
    ...
    <script type="text/javascript">
        ...
        var geojsonLayer = new L.GeoJSON.AJAX(base_url + "/assets/geojson/sulfur_2019.geojson", {
            style: function(feature) {
                p = feature.properties.s_mean;
                return {
        ...
        geojsonLayer.bindPopup(function(feature) {
            return feature.properties.s_mean;
        });
