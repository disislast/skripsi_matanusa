...
<body id="page-top">
    ...
    <script type="text/javascript">
        ...
        function getColor(fosfor_mea) {
            return fosfor_mea > 0.25 ? '#8904b1' :
                fosfor_mea > 0.19 ? '#2980b9' :
                fosfor_mea > 0.14 ? '#4cd137' :
                fosfor_mea > 0 ? '#c0392b' :
                '#bdc3c7';
        }

        var geojsonLayer = new L.GeoJSON.AJAX(base_url + "/assets/geojson/fosfor_2019.geojson", {
            style: function(feature) {
                p = feature.properties.p_mean;
                return {
            ...
            onEachFeature: function(feature, layer) {
                layer.on({
                    ...
                    click: function(e) {
                        var mean = feature.properties.p_mean.toFixed(3)
        ...
        info.update = function(props) {
            this._div.innerHTML = '<h4>Density of Makronutrient</h4>' + (props ?
                '<b>' + props.properties.grid + '</b><br />' + props.properties.p_mean + ' people / mi<sup>2</sup>' :
                'Hover over a state');
        };
