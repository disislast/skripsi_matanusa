...
<body id="page-top">
    ...
    <script type="text/javascript">
        ...
        var geojsonLayer = new L.GeoJSON.AJAX(base_url + "/assets/geojson/kalsium_2019.geojson", {
            style: function(feature) {
                p = feature.properties.ca_mean;
                return {
            ...
            onEachFeature: function(feature, layer) {
                layer.on({
                    ...
                    click: function(e) {
                        var mean = feature.properties.ca_mean.toFixed(3)
        ...
        geojsonLayer.bindPopup(function(feature) {
            return feature.properties.ca_mean;
        });
