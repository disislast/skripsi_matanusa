...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <h6 class="collapse-header">Non Essenstial:</h6>
                        <a class="collapse-item" href="<?= base_url('opetable/magnesium'); ?>">Magnesium(Mg)</a>
    ...
    <script type="text/javascript">
        ...
        var geojsonLayer = new L.GeoJSON.AJAX(base_url + "/assets/geojson/nitrogen_2019.geojson", {
            ...
            onEachFeature: function(feature, layer) {
                layer.on({
                    ...
                    click: function(e) {
                        var mean = feature.properties.n_mean.toFixed(3)
        ...
        /* geojsonLayer.bindPopup(function(e) {
            return e.properties.n_mean === values;
        }); */
        ...
        info.update = function(info) {
            this._div.innerHTML = '<h4>Density of Makronutrient</h4>' + (info ?
                '<b>' + String(info.properties.grid) + '</b><br />' + String(info.properties.n_mean) + ' people / mi<sup>2</sup>' :
                'Hover over a state');
        };
