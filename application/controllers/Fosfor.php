...
class Fosfor extends CI_Controller
{
    ...
    {
        $config['upload_path'] = 'assets/geojson/2fosfor/';
        ...
        if ($this->form_validation->run() == false) {
            ...
            if (!$this->upload->do_upload('fileupload')) {
                ...
                $this->db->insert('fosfor_file', $data);
    ...
    public function edit()
    {
        ...
        $result = $this->M_datamanager->ambil($id, 'fosfor_file');
    ...
    public function delete_data($id)
    {
        ...
        /* hapus file */
        $where = array('id' => $id);
        $result = $this->M_datamanager->ambil_file($where, 'fosfor_file');
        $url = $result['url'];
        $path = 'assets/geojson/2fosfor/';
        unlink($path . $url);
        /* hapus database */
        $this->M_datamanager->trash($where, 'fosfor_file');
