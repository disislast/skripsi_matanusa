...
class Kalsium extends CI_Controller
{
    ...
    {
        $config['upload_path'] = 'assets/geojson/5kalsium/';
        ...
        if ($this->form_validation->run() == false) {
            ...
            if (!$this->upload->do_upload('fileupload')) {
                ...
                $this->db->insert('kalsium_file', $data);
    ...
    public function edit()
    {
        ...
        $result = $this->M_datamanager->ambil($id, 'kalsium_file');
    ...
    public function delete_data($id)
    {
        ...
        /* hapus file */
        $where = array('id' => $id);
        $result = $this->M_datamanager->ambil_file($where, 'kalsium_file');
        $url = $result['url'];
        $path = 'assets/geojson/5kalsium/';
        unlink($path . $url);
        /* hapus database */
        $this->M_datamanager->trash($where, 'kalsium_file');
