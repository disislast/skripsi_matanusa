...
class Nitrogen extends CI_Controller
{
    ...
    {
        $config['upload_path'] = 'assets/geojson/1nitrogen/';
    ...
    public function edit()
    {
        ...
        $result = $this->M_datamanager->ambil($id, 'nitrogen_file');
    ...
    public function delete_data($id)
    {
        ...
        /* hapus file */
        $where = array('id' => $id);
        $result = $this->M_datamanager->ambil_file($where, 'nitrogen_file');
        $url = $result['url'];
        $path = 'assets/geojson/1nitrogen/';
        unlink($path . $url);
        /* hapus database */
        $this->M_datamanager->trash($where, 'nitrogen_file');
