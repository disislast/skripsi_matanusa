...
class Sulfur extends CI_Controller
{
    ...
    {
        $config['upload_path'] = 'assets/geojson/6sulfur/';
        ...
        if ($this->form_validation->run() == false) {
            ...
            if (!$this->upload->do_upload('fileupload')) {
                ...
                $this->db->insert('sulfur_file', $data);
    ...
    public function edit()
    {
        ...
        $result = $this->M_datamanager->ambil($id, 'sulfur_file');
    ...
    public function delete_data($id)
    {
        ...
        /* hapus file */
        $where = array('id' => $id);
        $result = $this->M_datamanager->ambil_file($where, 'sulfur_file');
        $url = $result['url'];
        $path = 'assets/geojson/6sulfur/';
        unlink($path . $url);
        /* hapus database */
        $this->M_datamanager->trash($where, 'sulfur_file');
